...
6. 回到“全部”，点按任务条中的“显示 AI 评分结果”切到“已AI评分”，采纳其余 3 张结果，使人物和风景各保留 2 张。
7. 点按底部命令条最右侧的“导出”按钮，选择任意可写目录并确认。确认弹窗会说明将复制的人物与风景张数；App 将样例分别复制到“人物”和“风景”子目录，并生成根 JSON/CSV 清单。
...
- 演示素材来源与完整性见[演示素材](../engineering/DEMO_ASSETS.md)。
