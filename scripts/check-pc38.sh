...
spec="docs/PEOPLE_SUBJECT_CLASSIFICATION.md"
acceptance="docs/PC38_ACCEPTANCE.md"
...
rg -q '人物 0 张、风景 159 张、读取失败 0 张' "$acceptance" ||
  fail "验收记录缺少当前项目完整复扫结果"
rg -A2 '## PC-38 街景人物误判收紧' docs/TASKS.md |
  rg -q '\*\*状态：已完成\*\*' ||
  fail "PC-38 尚未标记完成"
